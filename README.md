...
The wedding industry in India is one of the largest event management sectors in the world. Every wedding includes several categories of expenditure such as venue booking, decorations, photography, entertainment, catering, clothing, and miscellaneous services.
 ...
 Managing these expenses efficiently requires proper analysis of historical data. Data Analytics provides an effective way to discover spending patterns, identify major cost drivers, and support budget planning.
...
* Visualize relationships between different expense components.
...
Several statistical techniques are applied to understand the dataset.

Step 5: Visualization
Graphs are created to represent patterns and relationships among variables.
...
The project highlights the importance of data-driven decision-making in financial planning. It identifies key expense categories, reveals relationships among different costs, and provides practical insights that can assist families, event planners, and businesses in making informed budgeting decisions.

Beyond its practical applications, the project serves as an excellent example of applying data analytics techniques to a real-world dataset. It strengthens understanding of data preprocessing, statistical analysis, visualization, and interpretation, making it a valuable academic and professional portfolio project.
